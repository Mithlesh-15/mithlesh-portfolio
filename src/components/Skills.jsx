...
function Skills() {
  const line1 = [{ name: "React" }, { name: "React" }, { name: "React" }, { name: "React" }, { name: "React" }];
  return (
      ...
      <div className="w-full flex justify-center px-4">
        <div className="text-black flex flex-wrap justify-center gap-6">
          {line1.map((item, index) => (
            <div key={index} className="bg-white rounded-lg px-8 py-3 flex items-center gap-3 shadow-sm">
              <img
